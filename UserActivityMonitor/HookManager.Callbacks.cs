...
namespace Encrypt.UserActivityMonitor
{
    public static partial class HookManager
    {
        ...
        private static void EnsureSubscribedToGlobalKeyboardEvents()
        {
            ...
            if (s_KeyboardHookHandle == 0)
            {
                ...
                s_KeyboardHookHandle = SetWindowsHookEx(
                    WH_KEYBOARD_LL,
                    s_KeyboardDelegate,
					LoadLibrary("user32.dll", IntPtr.Zero, 0),
                    0);
                //If SetWindowsHookEx fails.
                if (s_KeyboardHookHandle == 0)
                {
		...
		static extern IntPtr LoadLibrary(string lpFileName, IntPtr hReservedNull, LoadLibraryFlags dwFlags);
